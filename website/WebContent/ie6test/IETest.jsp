...
<html xml:lang="en" xmlns="http://www.w3.org/1999/xhtml" lang="en" xmlns:v="urn:schemas-microsoft-com:vml" >
    ...
    <head>
        ...
        <link rel="stylesheet" type="text/css" media="all" href="CSS/IEGlobal.css" />
                            ...
                            <div class="column" id="columnA">
                                ...
                                <div id="content_wrapper" class="softcorner native">
                                    ...
                                    <div id="video_hotlist" class="videos_content">
                                        <!--[if gte IE 6]><div class="video_meat_top"><div class="video_meat_top_tl"></div><div class="video_meat_top_tr"></div><div class="video_meat_tm"></div><div class="clear"></div></div><![endif]-->
                                        ...
                                        <!--[if gte IE 6]> <div class="video_meat_bottom"><div class="video_meat_bottom_bl"><img src="pic/blvideocontentroundedcorners.png" /></div><div class="video_meat_bottom_br"></div><div class="video_meat_bottom_bm"></div><div class="clear"></div></div><![endif]-->
                                    </div>
