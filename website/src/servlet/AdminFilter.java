/*
 * This filter checks if the current user is one of the administrators of the site.
 * This filter should be applied to all pages that have access to administrative priviliges.
 */
...
public class AdminFilter implements Filter {
	...
	if (debug) log("AdminFilter:DoBeforeProcessing");
        ...
        IUser user = ServletCommon.getCurrentUser(req.getSession(true));
